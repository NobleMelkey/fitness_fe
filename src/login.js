      ...
      <header className="header">
        <nav>
          ...
          <ul className="nav__links" id="nav-links">
            ...
            <li className="link"><a href="#class">Classes</a></li>
            <li className="link"><a href="#trainer">Trainers</a></li>
            <li className="link"><a href="#price">Pricing</a></li>
            <li><button className="btn" id="form-open" onClick={handleClick}>Login</button></li>
          </ul>
        </nav>
